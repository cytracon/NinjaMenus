...
class Menu extends \Magento\Framework\View\Element\Template
{
     ...
     * @var string
     */
    protected $_template = 'Cytracon_NinjaMenus::menu.phtml';

    /**
     * @var Cytracon\NinjaMenus\Model\Menu
     */
    protected $_menu;
    ...
    /**
     * @var \Cytracon\NinjaMenus\Helper\Menu
     */
    ...
    protected function _construct()
    {
        ...
        $this->addData(
            [
                ...
                'cache_tags'     => [\Cytracon\NinjaMenus\Model\Menu::CACHE_TAG]
            ]
        );
    }
    ...
    /**
     * @param \Cytracon\NinjaMenus\Model\Menu $menu
     */
    ...
    {
        $menu = $this->getCurrentMenu();
        $block = $this->builderHelper->prepareProfileBlock(\Cytracon\Builder\Block\Profile::class, $menu->getProfile());
