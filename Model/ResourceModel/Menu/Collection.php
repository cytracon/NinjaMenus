...
namespace Cytracon\NinjaMenus\Model\ResourceModel\Menu;

use Cytracon\NinjaMenus\Api\Data\MenuInterface;

class Collection extends \Cytracon\NinjaMenus\Model\ResourceModel\AbstractCollection
{
    /**
     * @var string
     */
    ...
    {
        $this->_init(\Cytracon\NinjaMenus\Model\Menu::class, \Cytracon\NinjaMenus\Model\ResourceModel\Menu::class);
