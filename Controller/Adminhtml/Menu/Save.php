...
namespace Cytracon\NinjaMenus\Controller\Adminhtml\Menu;
...
class Save extends \Magento\Backend\App\Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Cytracon_NinjaMenus::menu_save';
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            /** @var \Cytracon\NinjaMenus\Model\Menu $model */
            $model = $this->_objectManager->create(\Cytracon\NinjaMenus\Model\Menu::class);
